		...
		<div class="row">
			...
			<div class="col-lg-9">
				<form class="col-md-12" method="post"
					...
					<input style="border-radius: 5px 5px 5px 5px; background-color: #d3dbd0;" type="submit" name="" value="Lọc">
				</form>
				<div class="row my-4">
					<c:forEach items="${sanpham }" var="sanPhams">
						<c:if test="${sanPhams.getLoaisp() == 1 }">
							<div class="col-lg-4 col-md-6 mb-4">
								<div class="card h-100">
									...
									<a
										href="${pageContext.request.contextPath }/gio-hang?action=themvaogio&id=${sanPhams.idsanpham}&page=listphone
									"
										type="button"
