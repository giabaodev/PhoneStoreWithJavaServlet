				...
				<div class="container-fluid">
					...
					<form method="post"
						...
						<c:forEach items="${sanPhams}" var="sanPhams">
							<input name="id" value="${sanPhams.idsanpham }" type="hidden">
							<div class="form-input-body">
								<label>Loại sản phẩm</label> <select name="loai" required>
							...
							<div class="form-input-body">
								<label>Tên sản phẩm</label> <input type="text" name="tensp"
									...
									value="${sanPhams.tensanpham }">
							</div>
							<div class="form-input-body">
								<label>Số lượng</label> <input type="text" name="sl"
									placeholder="Số lượng..." required value="${sanPhams.soluong }">
							</div>
							<div class="form-input-body">
								<label>Mô tả</label> <input type="text" name="mota"
									placeholder="Mô tả sản phẩm..." required
									value="${sanPhams.motasp }">
							</div>
							<div class="form-input-body">
								<label>Giá bán ($)</label> <input type="text" name="gia"
									placeholder="Giá sản phẩm..." required
									value="${sanPhams.giaban }">
							</div>
							<div class="form-input-body">
								<label>Hình ảnh</label> <img name="anh" required
									src="${sanPhams.hinhanh }" width="100" height="100">
							</div>
							<div class="form-input-body">
								<input type="submit" value="Cập nhật" class="mt-4"
